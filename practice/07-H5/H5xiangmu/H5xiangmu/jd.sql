...
USE jd;
CREATE TABLE jd_user(uid int primary key auto_increment,uname varchar(20),upwd varchar(25));
INSERT INTO jd_user VALUES(10,'qiangdong','123456'),(20,'naicha','456789');

CREATE TABLE jd_product(pid int primary key auto_increment,pname varchar(100),price float(6,2),pic varchar(100));
...
(26,'华为 P9 全网通 4GB+64GB版 金色 移动联通电信4G手机 双卡双待 后置1200万',3688.00, 'images/phone/phone_26.jpg'),(27,'乐视（Le）乐2（X620）32GB 原力金 移动联通电信4G手机 双卡双待 5.5英寸',988.00,'images/phone/phone_27.jpg'),
...
CREATE TABLE jd_cart(cid int primary key auto_increment,userId int);
INSERT INTO jd_cart VALUES(101,10);

CREATE TABLE jd_detail(did int primary key auto_increment,carId int,productId int,count int);
INSERT INTO jd_detail VALUES(1,101,15,3),(2,101,18,1),(3,101,21,2);
...
INSERT INTO jd_order VALUES(NULL,'强东妈','北京市海淀区','3565.00','1','120132345678','3','10');
INSERT INTO jd_order VALUES(NULL,'强东爸','北京市海淀区','3265.00','2','143032345678','4','10');
INSERT INTO jd_order VALUES(NULL,'强东弟','北京市海淀区','1565.00','3','140132345678','2','10');
INSERT INTO jd_order VALUES(NULL,'强东哥','北京市海淀区','2565.00','4','150132345678','1','10');
INSERT INTO jd_order VALUES(NULL,'强东姐','北京市海淀区','3365.00','1','120132345678','3','10');
...
INSERT INTO jd_order_detail VALUES(NULL,1,10,2);
INSERT INTO jd_order_detail VALUES(NULL,1,10,2);
INSERT INTO jd_order_detail VALUES(NULL,2,10,2);
INSERT INTO jd_order_detail VALUES(NULL,2,20,1);
INSERT INTO jd_order_detail VALUES(NULL,3,20,1);
INSERT INTO jd_order_detail VALUES(NULL,3,20,1);
INSERT INTO jd_order_detail VALUES(NULL,3,18,1);
INSERT INTO jd_order_detail VALUES(NULL,4,18,1);
INSERT INTO jd_order_detail VALUES(NULL,4,16,1);
INSERT INTO jd_order_detail VALUES(NULL,5,16,1);
INSERT INTO jd_order_detail VALUES(NULL,5,12,1);
INSERT INTO jd_order_detail VALUES(NULL,5,13,1);